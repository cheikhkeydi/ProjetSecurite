...
//Obtenue grâce au lien qui nous envoie sur stackOverflow
public class ExtendedAscii {
    ...
    //une fonction qui va récupérer l'index dans la table étendu d'un caractère
    //input : le caractère dans la norme java
    public static final int getIndexAsciiExtended(int code){
        int index = 127;
        while((char)(code) != getAscii(index)){
            index++;
        }
